...
reduction <- "umap"
cluster.name <- "RNA_snn_res.1.2"
# seurat_obj$RNA_snn_res.1.2
...
# Find markers 
# markers_5_vs_all <- FindMarkers(seurat_obj, 
#                                 ident.1 = 5,
...
# Export xlsx file 
out_file <- "26_mLN_topDEGs/out/mLN_Top_100_Cluster_DE_Markers.xlsx"
