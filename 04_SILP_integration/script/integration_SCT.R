...
Layers(seurat_merged[["SCT"]]) # Check that layers are split
...
ggsave("04_SILP_integration/plot/SCT/UMAP_SCT_pre_integration_orig.ident.pdf",
       width = 15,
       height = 5)
...
for (red in reductions){
  ...
  #   ggsave(glue("04_SILP_integration/plot/{assay}/UMAP_{reduction}_{x}.pdf"), 
  #          width = 8, 
  #          height = 7)
  #   
  # })
...
pdf(file = glue("04_SILP_integration/plot/{assay}/clustree_{cluster.name}.pdf"), width = 12, height = 10)
...
saveRDS(seurat_integrated, "04_SILP_integration/out/SILP_seurat_integrated_v5_SCT.rds")
# seurat_integrated <- readRDS("04_SILP_integration/out/seurat_integrated_v5_SCT.rds")
...
filename <- glue("04_SILP_integration/out/mydata_SCT_v5.h5Seurat")
