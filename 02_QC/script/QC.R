...
# Load data
seurat_obj_list <- readRDS("01_make_seurat_object/out/seurat_obj_list.rds") # cellranger filtered
...
saveRDS(seurat_obj_DoubletFinder, "02_QC/out/seurat_obj_QC_metrics.rds")
