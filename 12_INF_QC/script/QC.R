...
# Load data
seurat_obj <- readRDS("11_INF_make_seurat/out/INF_seurat_obj.rds") 
...
ggsave("12_INF_QC/plot/scDblFinder.pdf", width = 7, height = 6)
...
saveRDS(seurat_obj_QC, "12_INF_QC/out/INF_seurat_obj_QC_metrics.rds")
