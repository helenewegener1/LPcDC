...
# Load data
seurat_obj_raw <- readRDS("11_inflammation_make_seurat/out/INF_seurat_obj.rds") # raw = prefiltering 
seurat_obj_roughQC <- readRDS("12_inflammation_roughQC/out/INF_seurat_obj_roughQC.rds")
...
pdf(glue("13_inflammation_QC/plot/empty_droplets_plot_raw_{sample_name}.pdf"), width = 8, height = 6)
...
# Making Barcode Rank Plot.
pdf(glue("13_inflammation_QC/plot/empty_droplets_plot_roughQC_{sample_name}.pdf"), width = 8, height = 6)
...
seurat_obj_finalQC <- seurat_obj_roughQC
...
seurat_obj_finalQC@meta.data$DF.classification %>% table()

########################################## Export list of filtered Seurat objects ##########################################

saveRDS(seurat_obj_finalQC, "13_inflammation_QC/out/seurat_obj_finalQC.rds")
